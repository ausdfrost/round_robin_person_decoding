...
# Change this path only if you have saved the data to a different folder. Aus did!
#data_path = os.path.join(os.path.expanduser('~'), 'brainiak_datasets')
#data_path = '/packages/brainiak/data-20221103/brainiak_datasets'
data_path = '/projects/csnl/shared/round_robin_bids/batch_data/derivatives/fmriprep'
