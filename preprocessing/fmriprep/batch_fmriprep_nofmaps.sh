...
study=round_robin_qc

# Set subject list
sublist=`cat test_subject_list.txt`
...
sbatch --export ALL,subid=${sub},group_dir=${group_dir},study=${study},container=${container},freesurferlicense=${freesurferlicense} \
        ...
        --partition=short \
	--mem=100G \
	-o ${group_dir}/${study}/output/${SUBID}_${SESSID}_fmriprep_output.txt \
	-e ${group_dir}/${study}/output/${SUBID}_${SESSID}_fmriprep_error.txt \
